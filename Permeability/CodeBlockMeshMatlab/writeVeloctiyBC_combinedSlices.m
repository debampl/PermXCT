...
function writeVeloctiyBC_combinedSlices(fileID, ncol, nrow, nlevel, K)
...
fprintf(fileID,'\n');
fprintf(fileID,'\n');
fprintf(fileID,'dimensions      [0 1 -1 0 0 0 0];\n');
fprintf(fileID,'\n');
fprintf(fileID,'internalField      uniform (0 0 0);\n');
fprintf(fileID,'\n');
