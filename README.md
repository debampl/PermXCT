...
## Acknowledgement
The work of Debabrata Adhikari, Jesper Henri Hattel and Sankhya Mohanty has received funding from Horizon Europe, the European Union’s Framework Programme for Research, and Innovation, under Grant Agreement No. 101058054 (TURBO) https://turboproject.eu/. The work of Jesper Lisegaard has been supported by the Energy Technology Development and Demonstration Programme: Automated Lay-up processes in blade Manufacturing (ALMA) project (Grant No. 640222-495998).
...
Adhikari, Debabrata, Jesper John Lisegaard, Jesper Henri Hattel, and Sankhya Mohanty. "PermXCT: A novel framework for imaging-based virtual permeability prediction." SoftwareX 33 (2026): 102529. https://doi.org/10.1016/j.softx.2026.102529
## Research interest and application:
1.Adhikari, Debabrata, Jesper John Lisegaard, Robert S. Pierce, Lars Pilgaard Mikkelsen, Jesper Henri Hattel, and Sankhya Mohanty. "Meso-scale permeability prediction from the multi-block 3D reconstruction of fiber reinforced polymer composite with experimental validation." Composites Science and Technology (2025): 111290. https://doi.org/10.1016/j.compscitech.2025.111290
...
![Flowchart3](https://github.com/user-attachments/assets/dcee0fee-a03a-44cb-a753-c0cb5366f537)
...
The XCT dataset is presented in the [https://doi.org/10.5281/zenodo.14228043] (https://zenodo.org/records/14228043?preview=1&token=eyJhbGciOiJIUzUxMiIsImlhdCI6MTc1MjIyMTU0NywiZXhwIjoxNzU4NzU4Mzk5fQ.eyJpZCI6IjYyNjBhNGM5LTljMWQtNDc5Yy05NWE1LWQ0OTdlMzg3YmZkOCIsImRhdGEiOnt9LCJyYW5kb20iOiJjN2FkNWNlZGM1MjVhNmI4NmFmNTU3NmVmNGUyMzJkYSJ9.NgmFt9RhoP8p6yeXqCLJClC0d2AGa7UkxOhrKEmodj9jtw2ZTHhsWkwo4YLHhlZ419alovlc9Wh84Q5b3aCqIg) link. Users can use any type of XCT data format ready by Python libraries and perform the same for the prediction of virtual permeability. If the download link is not working, please ask the authors to generate a new link for downloading the dataset from Zenodo.
...
![image](https://github.com/user-attachments/assets/7e74060d-222c-4392-a18b-9e94eb0e81ad)
...
While running the permeability flow simulation
![{596CD080-F2B2-4458-8884-1C11DA8D28D2}](https://github.com/user-attachments/assets/7e295ca3-b405-48ac-b49b-44e7e9462901)
